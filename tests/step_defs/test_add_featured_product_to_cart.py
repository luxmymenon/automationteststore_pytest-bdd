...
@when(parsers.parse('I click on the add to cart thumbnail of the first featured product'))
...
@when(parsers.parse('I click Cart thumbnail'))
...
@when(parsers.parse('I click on Checkout button'))
