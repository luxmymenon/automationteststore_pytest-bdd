...
class BaseElement(object):
    ...
    #     # action_chain = ActionChains(self.driver)
    #     action_chain = self.action_chains_item()
    #     element1 = WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located(locator=self.locator))
    #     element2 = WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located(locator=self.locator))
    #     action_chain.drag_and_drop(element1, element2).perform()
    #     # action_chain.drag_and_drop(element, element).perform()
